...
useEffect(() => {
 ...
 current_office: record.current_office || 'Unknown Office',
  ...
  //   e.preventDefault();
  //     e.stopPropagation();
  //       console.log("Retention Period:", formData.retention_period); 
  //   try {
  //     const payload = {
  ...
  //     await axios.put(`/records/${selectedRecord.id}`, payload);
...
//   console.log("Payload being sent:", payload); // Log payload to check data structure

//   try {
//     const response = await axios.put(`/records/${selectedRecord.id}`, payload);
//     alert("Record updated successfully!");
//     setShowModal(false);
//     load();  // Reload the records to reflect the updated data
//   } catch (e) {
//     // Log detailed error response from the backend
//     console.error("Error response from backend:", e.response?.data || e.message);
//     alert("Failed to update record: " + (e.response?.data?.message || e.message));
//   }
// };
...
//   formData.append('control_number', formData.control_number);
//   formData.append('office_requestor', formData.office_requestor);
//   formData.append('description', formData.description);
//   formData.append('classification', formData.classification);
//   formData.append('priority', formData.priority);
//   formData.append('record_origin', formData.record_origin);
//   formData.append('concerned_personnel', formData.concerned_personnel);
//   formData.append('destination_office', formData.destination_office);
//   formData.append('retention_period', formData.retention_period);
...
//   try {
//     const response = await axios.put(`/records/${selectedRecord.id}`, formData, {
//       headers: {
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.put(`/records/${selectedRecord.id}`, formDataToSend, {
      headers: {
        'Content-Type': 'multipart/form-data', // Ensure content type is multipart/form-data
      },
    });
...
}, [records, q, office, classification, priority, docType, fromDate, toDate, filterType]);
...
<div className="d-flex justify-content-between">
  <label htmlFor="recordFilter" className="form-label">Filter by Record Type</label>
  <select
    id="recordFilter"
